...
const ReplayChatSchema = mongoose.Schema({
    username: {
        type: String,
    ...
    replayedMessage: {
        type: String,
        required: [true, "Missing replayed message."],
...
const ReplayChatModel = mongoose.model("ReplayChatModel", ReplayChatSchema, "chats");

module.exports = ReplayChatModel;